...
GanttFlow 是一款面向项目管理者和团队协作者的在线甘特图生成与分享工具。通过 AI 技术降低项目可视化门槛，让项目管理更简单高效。
...
查看 [GanttFlow_开发计划.md](GanttFlow_开发计划.md) 了解详细的开发路线图。
...
| M1 | 第 3-6 周 | 🚧 进行中 | MVP 核心功能、手动填写、甘特图渲染 |
| M2 | 第 7-10 周 | ⏳ 计划中 | AI 文件解析、字段识别 |
| M3 | 第 11-14 周 | ⏳ 计划中 | 权限管理、评论、PDF 导出 |
| M4 | 第 15-18 周 | ⏳ 计划中 | 实时协作、冲突处理 |

查看 [完整开发计划](GanttFlow_开发计划.md)
